#include "PhiTreeProof7.h"

void PhiTreeProof7::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof7::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof7::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof7::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof7::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits11.root","RECREATE");
