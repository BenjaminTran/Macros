#include "PhiTreeProof1.h"

void PhiTreeProof1::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof1::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof1::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof1::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof1::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits5.root","RECREATE");
