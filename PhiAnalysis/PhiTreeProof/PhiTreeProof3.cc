#include "PhiTreeProof3.h"

void PhiTreeProof3::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof3::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof3::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof3::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof3::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits7.root","RECREATE");
