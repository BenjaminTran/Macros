#include "PhiTreeProof8.h"

void PhiTreeProof8::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof8::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof8::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof8::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof8::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits12.root","RECREATE");
