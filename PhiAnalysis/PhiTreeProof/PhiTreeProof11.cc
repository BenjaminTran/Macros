#include "PhiTreeProof11.h"

void PhiTreeProof11::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof11::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof11::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof11::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof11::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits15.root","RECREATE");
