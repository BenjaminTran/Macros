#include "PhiTreeProof4.h"

void PhiTreeProof4::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof4::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof4::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof4::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof4::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits8.root","RECREATE");
