#include "PhiTreeProof10.h"

void PhiTreeProof10::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof10::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof10::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof10::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof10::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits14.root","RECREATE");
