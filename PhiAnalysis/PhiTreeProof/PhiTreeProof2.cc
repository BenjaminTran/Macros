#include "PhiTreeProof2.h"

void PhiTreeProof2::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof2::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof2::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof2::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof2::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits6.root","RECREATE");
