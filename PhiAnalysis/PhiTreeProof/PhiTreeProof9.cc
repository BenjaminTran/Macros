#include "PhiTreeProof9.h"

void PhiTreeProof9::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof9::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof9::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof9::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof9::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits13.root","RECREATE");
