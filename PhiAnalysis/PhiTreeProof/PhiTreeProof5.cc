#include "PhiTreeProof5.h"

void PhiTreeProof5::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof5::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof5::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof5::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof5::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits9.root","RECREATE");
