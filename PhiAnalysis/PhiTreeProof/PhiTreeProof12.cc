#include "PhiTreeProof12.h"

void PhiTreeProof12::CombinatorialMass(std::vector<kaon_proof> PKp, std::vector<kaon_proof> PKm, TH1D* h_mass_)
{
...
void PhiTreeProof12::Init(TTree *tree)
{
    reader.SetTree(tree);
}

void PhiTreeProof12::SlaveBegin(TTree *tree)
{
...
bool PhiTreeProof12::Process(Long64_t entry)
{
    h_nEvt->Fill(1);
...
void PhiTreeProof12::Terminate()
{
    ...
    out = new TFile("outputFiles/Histograms_tight_midRap_nhits16.root","RECREATE");
