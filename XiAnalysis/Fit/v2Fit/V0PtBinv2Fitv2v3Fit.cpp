...
void V0PtBinv2Fit(  )
{
    ...
    std::vector<double> v5values_ks_peak;
	...
	std::vector<double> v5error_ks_peak;
    ...
    std::vector<double> v5values_ks_side;
	...
	std::vector<double> v5error_ks_side;
	std::vector<double> v6error_ks_side;
	std::vector<double> v7error_ks_side;
    double v2value_h = 0;
    double v3value_h = 0;
    double v4value_h = 0;
    double v5value_h = 0;
    ...
    std::vector<double> v2values_la_peak;
	std::vector<double> v3values_la_peak;
    std::vector<double> v4values_la_peak;
    std::vector<double> v5values_la_peak;
    std::vector<double> v6values_la_peak;
    std::vector<double> v7values_la_peak;

    std::vector<double> v2values_la_side;
	std::vector<double> v3values_la_side;
    std::vector<double> v4values_la_side;
    std::vector<double> v5values_la_side;
    std::vector<double> v6values_la_side;
    std::vector<double> v7values_la_side;

    std::vector<double> v2error_la_peak;
	std::vector<double> v3error_la_peak;
	std::vector<double> v4error_la_peak;
	std::vector<double> v5error_la_peak;
	std::vector<double> v6error_la_peak;
	std::vector<double> v7error_la_peak;

    std::vector<double> v2error_la_side;
	std::vector<double> v3error_la_side;
	std::vector<double> v4error_la_side;
	std::vector<double> v5error_la_side;
	std::vector<double> v6error_la_side;
	std::vector<double> v7error_la_side;
    double v2error_h = 0;
    double v3error_h = 0;
    double v4error_h = 0;
    double v5error_h = 0;
    ...
    for( int i=0; i<numPtBins_ks; i++ )
    {
        ...
        v2values_ks_side.push_back( FourierFit_ks[i]->GetParameter( 2 ) );
        v2error_ks_side.push_back( FourierFit_ks[i]->GetParError( 2 ) );
        v3values_ks_side.push_back( FourierFit_ks[i]->GetParameter( 3 ) );
        v3error_ks_side.push_back( FourierFit_ks[i]->GetParError( 3 ) );
    ...
    for( int i=0; i<numPtBins_la; i++ )
    {
        ...
        v2values_la_peak.push_back( FourierFit_la[i]->GetParameter( 2 ) );
        v2error_la_peak.push_back( FourierFit_la[i]->GetParError( 2 ) );
        v3values_la_peak.push_back(FourierFit_la[i]->GetParameter(3));
        v3error_la_peak.push_back(FourierFit_la[i]->GetParError(3));
        ...
        v2values_la_side.push_back( FourierFit_la[i]->GetParameter( 2 ) );
        v2error_la_side.push_back( FourierFit_la[i]->GetParError( 2 ) );
        v3values_la_side.push_back( FourierFit_la[i]->GetParameter( 3 ) );
        v3error_la_side.push_back( FourierFit_la[i]->GetParError( 3 ) );
