...
void OmvnFit(  )
{
    ...
    std::string Xiv2PeakName = "Omv2RapPeak.txt";
    std::string Xiv2SideName = "Omv2RapSide.txt";
    std::string Xiv2CalculatorName = "Omv2RapSignal.txt";
    ...
    TFile *f = new TFile("/volumes/MacHD/Users/blt1/research/RootFiles/Flow/OmCorr/OmCorrelationRapidityTotal_09_24_17.root" );
