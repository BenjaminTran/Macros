...
void MainFit(  )
{
    ...
    TFile* f = new TFile( "/volumes/MacHD/Users/blt1/research/TestRootFiles/XiAnalysisCorrelationPtCut8TeVPD1Test.root" );
    ...
    // Draw Histgorams
    TCanvas* MassPtBinned = new TCanvas( "MassPtBinned","",1600,800 );
    c1->Divide( 4,2 );
