...
void Rap_Cascade_v2()
{
    ...
    double v2Ks8[ks_npoints]  = {0.018392 ,0.0289959 ,0.0428532 ,0.0598327 ,0.082664 ,0.10635 ,0.124404 ,0.138096 ,0.146914 ,0.143748 ,0.135453 ,0.120565 ,0.129571 ,0.118902 ,0.13203 ,0.0314042};
    ...
    double v2Ks8E[ks_npoints] = {0.00376073 ,0.000902464 ,0.000527673 ,0.000429942 ,0.000279996 ,0.000300593 ,0.000360446 ,0.000390521 ,0.000516156 ,0.000775071 ,0.00121919 ,0.00253201 ,0.00332405 ,0.00544029 ,0.0072796 ,0.0530176};

	const int la_npoints = 13;
    double v2La8[la_npoints]  = {0.0353569 ,0.0516286 ,0.077228 ,0.107623 ,0.138128 ,0.171591 ,0.193791 ,0.200922 ,0.200435 ,0.176451 ,0.180207 ,0.168649 ,0.181285};
    double pTLa8[la_npoints]  = {0.9252, 1.224, 1.603, 1.995, 2.485, 3.156, 4.007, 5.116, 6.414, 7.588, 9.117, 11.56, 16.89};
    double v2La8E[la_npoints] = {0.00184779 ,0.000756154 ,0.000670732 ,0.000685073 ,0.000622614 ,0.000689661 ,0.000971346 ,0.00162469 ,0.00386574 ,0.00556452 ,0.0109956 ,0.012792 ,0.10688};
    ...
    TLegend* leg = new TLegend(0.7609489,0.6673684,0.879562,0.8715789);
    leg->SetFillColor(10);
    leg->SetFillStyle(0);
    leg->SetBorderSize(0.035);
    leg->SetTextFont(42);
